sap.ui.define(["sap/ui/model/json/JSONModel"], function(JSONModel) {
	...
	var LOW_SOCIAL = 162.73,
		LOW_SOCIAL_WITH_SICKNESS = 176.33,
		HIGH_SOCIAL = 713.35,
		HIGH_SOCIAL_WITH_SICKNESS = 772.96,
		HEALTH = 288.95,
		LABOR_FUND = 58.88,
	...
	B2BCalculator.prototype.buildUI5Model = function() {
		...
		var oData = {
			...
			totalSocialContributionValue: (this.totalSocialContributionValue *-1).toFixed(2),
	...
	B2BCalculator.prototype.calcClearIncome = function() {
		this.clearIncome = this.grossValue - this.vatValue - this.totalSocialContributionValue - this.donationTotal - this.netExpenses;
	};
	...
	B2BCalculator.prototype.calcIncomeTaxScale = function() {
		var income = this.netIncome - this.netExpenses - this.socialContributionValue;
		...
		if (this.donation32 !== 0 && this.donation32 >= this.healthContributeTaxReduce) {
	...
	B2BCalculator.prototype.calcIncomeTaxFlat = function() {
		this.donation19 = this.calcPercentOfValue(TAX_FLAT, this.netIncome - this.netExpenses - this.socialContributionValue);
	...
	B2BCalculator.prototype.calculateSocialSecurityContributions = function() {
		...
		/* Total Calculation */
		this.totalSocialContributionValue = this.socialContributionValue + this.healthContributionValue + this.laborFundContributionValue;
	};
